...
\author{Your name}
\school{计算机科学与技术学院}
\classnum{Your classnum}
\stunum{Your stunum}
\instructor{Your teacher} % 该系列实验报告模板有华科大计院教师陈加忠制作
\date{2022年5月20日}
...
\lstdefinestyle{顺序表}{
    ...
    stringstyle=\rmfamily\slshape\color[RGB]{137,202,120},
%显示空格
    showstringspaces=false,
    linewidth=1.25\linewidth,identifierstyle=\color{red},
    breaklines=true,morecomment=[l]{//},
    morekeywords=[2]{printf,break,scanf,getchar,system,switch}, keywordstyle=[2]{\color[RGB]{213,95,222}},
...
\lstdefinestyle{邻接表图}{
    ...
    belowskip=1pt,
    escapeinside=``,
    xleftmargin=2em,xrightmargin=2em, aboveskip=1em,morekeywords={},
    keywordstyle=\color{blue}\bfseries,
    identifierstyle=\bf,
    numberstyle=\color[RGB]{192,192,192},
    commentstyle=\bfseries,
...
\begin{document}
    ...
    \nocite{*}
    \bibliography{Bibs/1}%此图插入你的bib文件
